...
gh label create "architecture"     --color "0075ca" --description "LLMアーキテクチャ・事前学習" --repo $REPO
gh label create "fine-tuning"      --color "e4e669" --description "ファインチューニング・RLHF・アライメント" --repo $REPO
gh label create "evaluation"       --color "d93f0b" --description "評価・ベンチマーク" --repo $REPO
gh label create "embedding"        --color "0e8a16" --description "テキスト埋め込み・RAG" --repo $REPO
gh label create "interpretability" --color "5319e7" --description "モデル解釈・内部表現" --repo $REPO
gh label create "safety"           --color "b60205" --description "安全性・アライメント" --repo $REPO
